...
// import 'package:multi_dropdown/src/models/chip_config.dart';
// import 'package:multi_dropdown/src/models/dropdown_item.dart';
// import 'package:multi_dropdown/src/models/network_request.dart';
// import 'package:multi_dropdown/src/widgets/hint_text.dart';
// import 'package:multi_dropdown/src/widgets/selection_chip.dart';
// import 'package:multi_dropdown/src/widgets/single_selected_item.dart';
...
//     } else {
//       _options.addAll(
//         _controller.options.isNotEmpty == true
//             ? _controller.options
//             : widget.options,
//       );
//     }
...
//         _controller.disabledOptions.isNotEmpty == true
...
//         final selectedOptions = <ValueItem<T>>[..._selectedOptions];
...
//       final parsedOptions = await widget.networkRequest!.responseParser!(data);
//       _reponseBody = null;
...
//                         mainAxisSize: MainAxisSize.min,
//                         children: [
//                           if (widget.networkRequest?.responseErrorBuilder !=
//                               null)
