...
class MultiDropdown<T extends Object> extends StatefulWidget {
  ...
  const MultiDropdown({
    ...
    this.loadingItemsBuilder = const CircularProgressIndicator.adaptive(),
    Key? key,
  })  : future = null,
        super(key: key);
  ...
  /// The widget displayed while loading elements.
  final Widget loadingItemsBuilder;
...
class _MultiDropdownState<T extends Object> extends State<MultiDropdown<T>> {
  ...
  Widget? _buildSuffixIcon() {
    if (_loadingController.value) {
      return widget.loadingItemsBuilder;
    }
