...
class _MultiDropdownState<T extends Object> extends State<MultiDropdown<T>> {
              ...
              builder: (_, __) {
                return InkWell(
                  ...
                  child: InputDecorator(
                    isEmpty: !widget.showSelectedItems || _dropdownController.selectedItems.isEmpty,
                    isFocused: _dropdownController.isOpen,
                    decoration: _buildDecoration(),
                    textAlign: TextAlign.start,
                    textAlignVertical: TextAlignVertical.center,
                    child: widget.showSelectedItems ? _buildField() : const SizedBox(),
                  ),
                );
              },
            ),
  ...
  InputDecoration _buildDecoration() {
    ...
    return InputDecoration(
      ...
      isCollapsed: fieldDecoration.isCollapsed,
    );
  }
